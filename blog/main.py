...
@app.delete('/blog/{id}',status_code=status.HTTP_204_NO_CONTENT,tags=["Blogs"])        # 204 is bound to return no content
...
@app.put('/blog/{id}',status_code=status.HTTP_202_ACCEPTED,tags=["Blogs"])     # update a existing post
